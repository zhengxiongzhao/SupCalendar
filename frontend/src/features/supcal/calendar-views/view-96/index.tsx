...
export function CalendarView96() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 96 · 海洋月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>海洋/水波纹主题，蓝色渐变</p>
          </div>
        </div>
