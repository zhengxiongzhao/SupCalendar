...
export function CalendarView121() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 121 · 烟花月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>烟花爆炸式日程展示，放射状</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-11 w-full flex-col items-center justify-center rounded-xl text-xs transition-all',
