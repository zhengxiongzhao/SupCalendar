...
export function CalendarView113() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 113 · 积木月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>乐高积木风格，凸起圆点装饰</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='flex gap-6'>
            <div className='w-[300px] shrink-0 space-y-4'>
              ...
              <div className='flex items-center justify-between mb-4 py-2 border-y border-dashed border-border/30'>
              <div className='flex items-center gap-2'><Wallet className='h-4 w-4 text-muted-foreground' /><span className='text-xs text-muted-foreground'>本月合计</span></div>
              <div className='flex items-center gap-4'>
                <span className='text-xs font-medium text-emerald-600 dark:text-emerald-400'>+{formatAmount(summary.income, 'CNY')}</span>
                <span className='text-xs font-medium text-rose-600 dark:text-rose-400'>-{formatAmount(summary.expense, 'CNY')}</span>
              </div>
            </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-sm border-2 border-yellow-500/20 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>乐高积木风格，凸起圆点装饰</p>
                    </div>
                  </div>
