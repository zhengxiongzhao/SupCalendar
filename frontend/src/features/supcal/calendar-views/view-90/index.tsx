...
export function CalendarView90() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 90 · 玻璃态月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>毛玻璃/磨砂效果，半透明卡片</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-2xl backdrop-blur-sm bg-white/30 dark:bg-white/5 border border-white/20 text-xs transition-all',
