    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 49 · 纺织日历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>绿色编织风格</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-lime-500/5 to-card shadow-sm'>
