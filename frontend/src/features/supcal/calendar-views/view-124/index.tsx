...
export function CalendarView124() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 124 · 砖墙月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>砖墙砌筑风格，错落排列效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-9 w-full flex-col items-center justify-center rounded-sm border border-red-500/15 text-xs transition-all',
