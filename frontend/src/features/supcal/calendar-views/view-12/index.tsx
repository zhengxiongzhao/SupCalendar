...
import { ChevronLeft, ChevronRight, CalendarDays, FolderOpen, Tag, Clock , TrendingUp , TrendingDown } from 'lucide-react'
...
import { buildRecordsByDateMap, getRecordDotColor, format as fmt , getRecordColorClasses } from '../shared'
...
export function CalendarView12() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 12 · 树形概览</h1>
