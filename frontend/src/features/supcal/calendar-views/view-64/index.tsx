...
export function CalendarView64() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 64 · 金字塔</h1>
            <p className='mt-1 text-sm text-muted-foreground'>金字塔式信息层级，重要日程置顶</p>
          </div>
        </div>
