...
export function CalendarView104() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 104 · 条纹月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>条纹/斑马纹风格，交替行颜色</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-9 w-full flex-col items-center justify-center rounded-none text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>条纹/斑马纹风格，交替行颜色</p>
                    </div>
                  </div>
