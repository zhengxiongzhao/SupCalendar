...
export function CalendarView51() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 51 · 数据矩阵</h1>
            <p className='mt-1 text-sm text-muted-foreground'>终端/矩阵风格，绿色数字雨背景</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-8 w-full flex-col items-center justify-center rounded-none font-mono text-xs transition-all',
