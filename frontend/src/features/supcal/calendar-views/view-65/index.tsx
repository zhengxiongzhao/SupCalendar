...
export function CalendarView65() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 65 · 拼图月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>拼图块式日期格子，连接效果</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='flex gap-6'>
            <div className='w-[340px] shrink-0 space-y-4'>
              ...
              <div className='flex gap-2 mb-4 h-2 rounded-full overflow-hidden bg-muted/20'>
              <div className='rounded-full bg-emerald-500/60' style={{width: `${summary.income / (summary.income + summary.expense || 1) * 100}%`}} />
              <div className='rounded-full bg-rose-500/60' style={{width: `${summary.expense / (summary.income + summary.expense || 1) * 100}%`}} />
            </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>拼图块式日期格子，连接效果</p>
                    </div>
                  </div>
