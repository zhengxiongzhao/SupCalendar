    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 65 · 棱柱视图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>粉红棱柱渐变</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-pink-500/5 to-rose-500/5 shadow-sm'>
