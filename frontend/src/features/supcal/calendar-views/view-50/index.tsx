...
export function CalendarView50() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 50 · 温度计月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>温度计式收支指示，颜色渐变</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-11 w-full flex-col items-center justify-center rounded-b-full rounded-t-sm text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>温度计式收支指示，颜色渐变</p>
                    </div>
                  </div>
