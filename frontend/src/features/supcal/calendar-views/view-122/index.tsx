...
export function CalendarView122() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 122 · 拼字游戏</h1>
            <p className='mt-1 text-sm text-muted-foreground'>Scrabble 拼字游戏风格，方块格</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-sm border border-amber-500/30 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>Scrabble 拼字游戏风格，方块格</p>
                    </div>
                  </div>
