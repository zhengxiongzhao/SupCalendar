...
export function CalendarView105() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 105 · 雷达月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>雷达/扫描风格，脉冲扫描效果</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='flex gap-6'>
            <div className='w-[340px] shrink-0 space-y-4'>
              ...
              <div className='rounded-sm bg-foreground/5 p-2'><p className='text-[9px] text-muted-foreground'>白方 · 收入</p><p className='text-xs font-bold text-emerald-600 dark:text-emerald-400'>{formatAmount(summary.income, 'CNY')}</p></div>
              <div className='rounded-sm bg-foreground/5 p-2'><p className='text-[9px] text-muted-foreground'>黑方 · 支出</p><p className='text-xs font-bold text-rose-600 dark:text-rose-400'>{formatAmount(summary.expense, 'CNY')}</p></div>
            </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-full ring-1 ring-green-500/20 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>雷达/扫描风格，脉冲扫描效果</p>
                    </div>
                  </div>
