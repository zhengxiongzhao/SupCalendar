...
export function CalendarView72() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 72 · 转盘月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>转盘/轮盘式布局，圆形日期选择</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-auto w-full flex-col items-center justify-center rounded-full text-xs transition-all',
