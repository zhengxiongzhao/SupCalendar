...
import { ChevronLeft, ChevronRight, CalendarDays, ArrowDown } from 'lucide-react'
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 17 · 上下布局</h1>
            <p className='mt-1 text-sm text-muted-foreground'>全宽月历在上 + 日程列表在下</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <>
            ...
            <div className='mt-4 rounded-xl border border-border/40 bg-card p-3 shadow-sm'>
