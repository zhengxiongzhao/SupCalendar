...
export function CalendarView102() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 102 · 代码终端</h1>
            <p className='mt-1 text-sm text-muted-foreground'>终端/命令行风格，等宽字体展示</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-8 w-full flex-col items-center justify-center rounded-none font-mono border border-green-500/20 text-xs transition-all',
