...
export function CalendarView125() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 125 · 音符月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>音乐/五线谱风格，音符式标记</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='flex gap-6'>
            <div className='w-[300px] shrink-0 space-y-4'>
              ...
              <div className='rounded-sm bg-yellow-100 dark:bg-yellow-900/20 px-3 py-1.5 -rotate-1 shadow-sm'><span className='text-xs font-medium text-amber-700 dark:text-amber-400'>收入 {formatAmount(summary.income, 'CNY')}</span></div>
              <div className='rounded-sm bg-pink-100 dark:bg-pink-900/20 px-3 py-1.5 rotate-1 shadow-sm'><span className='text-xs font-medium text-rose-700 dark:text-rose-400'>支出 {formatAmount(summary.expense, 'CNY')}</span></div>
            </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg border-b-2 border-purple-500/20 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>音乐/五线谱风格，音符式标记</p>
                    </div>
                  </div>
