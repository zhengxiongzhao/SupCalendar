...
export function CalendarView98() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 98 · 树木年轮</h1>
            <p className='mt-1 text-sm text-muted-foreground'>年轮/同心圆风格，环状信息展示</p>
          </div>
        </div>
