...
import { ChevronLeft, ChevronRight, CalendarDays, TrendingUp, TrendingDown, Wallet, LayoutList } from 'lucide-react'
...
export function CalendarView16() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 16 · 经典月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>经典双栏布局，左侧完整月历 + 右侧日程卡片</p>
          </div>
        </div>
              ...
              <div className='mb-4 flex items-center justify-between rounded-xl border border-border/60 bg-card px-4 py-3 shadow-sm'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    {selectedDate && <p className='text-[11px] text-muted-foreground'>{fmt(selectedDate, 'yyyy年M月d日 EEEE', { locale: zhCN })}</p>}
                  </div>
                </div>
