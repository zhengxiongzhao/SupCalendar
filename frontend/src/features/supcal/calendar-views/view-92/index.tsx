...
export function CalendarView92() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 92 · 星星月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>星空评分风格，星级重要性标记</p>
          </div>
        </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>星空评分风格，星级重要性标记</p>
                    </div>
                  </div>
