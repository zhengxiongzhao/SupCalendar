...
export function CalendarView128() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 128 · 瀑布线图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>瀑布流线图，连续连接的日程节点</p>
          </div>
        </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>瀑布流线图，连续连接的日程节点</p>
                    </div>
                  </div>
