    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 56 · 细胞视图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>青紫细胞配色</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-teal-500/5 to-purple-500/5 shadow-sm'>
