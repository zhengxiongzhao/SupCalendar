...
export function CalendarView115() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 115 · 沙漠月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>沙漠/沙丘主题，沙色渐变纹理</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg border border-amber-500/15 text-xs transition-all',
