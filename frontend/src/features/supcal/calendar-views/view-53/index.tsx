...
export function CalendarView53() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 53 · 书架月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>书架式布局，每行一层书架效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-9 w-full flex-col items-center justify-center rounded-sm border-b-2 text-xs transition-all',
