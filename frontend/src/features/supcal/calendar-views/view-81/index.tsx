...
export function CalendarView81() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 81 · 像素月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>复古像素游戏风格，8bit 方块</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-8 w-full flex-col items-center justify-center rounded-none border border-green-500/30 text-xs transition-all',
