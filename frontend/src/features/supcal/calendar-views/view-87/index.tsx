...
export function CalendarView87() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 87 · 日历卷轴</h1>
            <p className='mt-1 text-sm text-muted-foreground'>卷轴/卷轴式展开，古典卷边</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg border-x-4 border-amber-200 dark:border-amber-900 text-xs transition-all',
