...
export function CalendarView45() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 45 · 波浪月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>波浪分隔线，流动感日程展示</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg text-xs transition-all',
