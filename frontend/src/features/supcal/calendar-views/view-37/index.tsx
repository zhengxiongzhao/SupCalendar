    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 37 · 收支天平</h1>
            <p className='mt-1 text-sm text-muted-foreground'>收支对比天平可视化，平衡度指示器</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-11 w-full flex-col items-center justify-center rounded-xl shadow-sm text-xs transition-all',
