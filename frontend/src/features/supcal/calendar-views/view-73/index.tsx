...
export function CalendarView73() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 73 · 树形月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>树形结构日程，分支展开</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='flex gap-6'>
            <div className='w-[300px] shrink-0 space-y-4'>
              ...
              <div className='flex items-center justify-center gap-4 mb-4 py-3 rounded-xl bg-card border border-border/40'>
              <div className='text-center'><TrendingUp className='mx-auto h-4 w-4 text-emerald-500' /><p className='text-xs font-bold text-emerald-600 dark:text-emerald-400'>{formatAmount(summary.income, 'CNY')}</p></div>
              <div className={cn('h-8 w-0.5 rounded', summary.balance >= 0 ? 'bg-emerald-500/30' : 'bg-rose-500/30')} />
              <div className='text-center'><TrendingDown className='mx-auto h-4 w-4 text-rose-500' /><p className='text-xs font-bold text-rose-600 dark:text-rose-400'>{formatAmount(summary.expense, 'CNY')}</p></div>
            </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>树形结构日程，分支展开</p>
                    </div>
                  </div>
