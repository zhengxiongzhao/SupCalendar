...
export function CalendarView101() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 101 · 面包屑月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>面包屑导航式日期路径，层级展示</p>
          </div>
        </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>面包屑导航式日期路径，层级展示</p>
                    </div>
                  </div>
