...
export function CalendarView85() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 85 · 药丸月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>药丸/胶囊式日程条，圆角条形</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-8 w-full flex-col items-center justify-center rounded-full text-xs transition-all',
