...
export function CalendarView74() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 74 · 层叠卡片</h1>
            <p className='mt-1 text-sm text-muted-foreground'>堆叠式卡片，3D 透视效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg shadow-sm text-xs transition-all',
