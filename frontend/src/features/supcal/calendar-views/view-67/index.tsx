    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 67 · 波纹视图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>紫蓝波纹配色</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-purple-500/5 to-indigo-500/5 shadow-sm'>
