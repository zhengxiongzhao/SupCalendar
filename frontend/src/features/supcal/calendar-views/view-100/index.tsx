...
export function CalendarView100() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 100 · 渐变流月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>渐变流光效果，动态色彩过渡</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-xl bg-gradient-to-r from-violet-500/5 via-pink-500/5 to-cyan-500/5 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>渐变流光效果，动态色彩过渡</p>
                    </div>
                  </div>
