...
export function CalendarView99() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 99 · 像素艺术</h1>
            <p className='mt-1 text-sm text-muted-foreground'>像素画风格日程，色块组成图标</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-8 w-full flex-col items-center justify-center rounded-none text-xs transition-all',
