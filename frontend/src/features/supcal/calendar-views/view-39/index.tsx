    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 39 · 报纸排版</h1>
            <p className='mt-1 text-sm text-muted-foreground'>经典报纸式双栏排版，大标题月历</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-9 w-full flex-col items-center justify-center rounded-none border-b-2 text-xs transition-all',
