...
export function CalendarView120() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 120 · 冰晶月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>冰晶/雪花主题，冬季冷色调</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-xl ring-1 ring-sky-500/20 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>冰晶/雪花主题，冬季冷色调</p>
                    </div>
                  </div>
