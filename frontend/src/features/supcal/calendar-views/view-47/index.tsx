...
export function CalendarView47() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 47 · 交通信号</h1>
            <p className='mt-1 text-sm text-muted-foreground'>红黄绿信号灯式收支状态指示</p>
          </div>
        </div>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>红黄绿信号灯式收支状态指示</p>
                    </div>
                  </div>
