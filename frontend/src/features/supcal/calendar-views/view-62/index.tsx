    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 62 · 漩涡视图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>深紫漩涡风格</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-violet-500/5 to-fuchsia-500/5 shadow-sm'>
