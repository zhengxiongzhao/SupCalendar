...
export function CalendarView94() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 94 · 棱镜月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>棱镜折射风格，彩虹渐变效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-lg bg-gradient-to-br text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>棱镜折射风格，彩虹渐变效果</p>
                    </div>
                  </div>
