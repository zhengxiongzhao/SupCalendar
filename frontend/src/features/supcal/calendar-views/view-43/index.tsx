    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 43 · 锯齿视图</h1>
            <p className='mt-1 text-sm text-muted-foreground'>锯齿边框风格日历</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border-2 border-dashed border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-card shadow-sm'>
