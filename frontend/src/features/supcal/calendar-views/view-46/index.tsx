...
export function CalendarView46() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 46 · 邮戳月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>邮票边框日期格，邮戳标记有记录的日子</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded border-2 border-dashed text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>邮票边框日期格，邮戳标记有记录的日子</p>
                    </div>
                  </div>
