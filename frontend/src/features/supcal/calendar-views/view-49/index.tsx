...
export function CalendarView49() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 49 · 标签云月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>标签云式日程展示，大小随金额变化</p>
          </div>
        </div>
        {recordsQuery.isLoading ? (
          ...
          <div className='space-y-6'>
              ...
              <div className='flex items-center gap-3 rounded-xl bg-card p-3 border border-border/40'>
                <div className='flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500/10'><TrendingUp className='h-4 w-4 text-emerald-500' /></div>
                <div><p className='text-[10px] text-muted-foreground'>收入</p><p className='text-sm font-bold text-emerald-600 dark:text-emerald-400'>{formatAmount(summary.income, 'CNY')}</p></div>
              </div>
              <div className='flex items-center gap-3 rounded-xl bg-card p-3 border border-border/40'>
                <div className='flex h-10 w-10 items-center justify-center rounded-full bg-rose-500/10'><TrendingDown className='h-4 w-4 text-rose-500' /></div>
                <div><p className='text-[10px] text-muted-foreground'>支出</p><p className='text-sm font-bold text-rose-600 dark:text-rose-400'>{formatAmount(summary.expense, 'CNY')}</p></div>
              </div>
            </div>
