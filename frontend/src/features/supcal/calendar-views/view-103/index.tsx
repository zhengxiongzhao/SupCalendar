...
export function CalendarView103() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 103 · 唱片月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>黑胶唱片风格，旋转动画效果</p>
          </div>
        </div>
