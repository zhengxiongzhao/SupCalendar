...
import { ChevronLeft, ChevronRight, CalendarDays, TrendingUp, TrendingDown, Wallet, FolderOpen } from 'lucide-react'
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 32 · 分组列表</h1>
            <p className='mt-1 text-sm text-muted-foreground'>月历网格 + 按类型折叠分组的日程列表</p>
          </div>
        </div>
