    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 45 · 涂鸦日历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>点线涂鸦风格</p>
          </div>
        </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-dotted border-border/50 bg-gradient-to-br from-pink-500/5 to-card shadow-sm'>
