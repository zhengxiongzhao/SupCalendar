...
export function CalendarView132() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 132 · 折扇月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>中国折扇风格，扇形展开效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-10 w-full flex-col items-center justify-center rounded-b-2xl text-xs transition-all',
