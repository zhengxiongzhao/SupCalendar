...
export function CalendarView43() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 43 · 泡泡月历</h1>
            <p className='mt-1 text-sm text-muted-foreground'>圆形泡泡日期格子，悬浮效果</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-auto w-full flex-col items-center justify-center rounded-full aspect-square text-xs transition-all',
