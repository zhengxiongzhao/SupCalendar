...
export function CalendarView60() {
    ...
    <>
      ...
      <Main>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>日历视图 60 · 蓝图方格</h1>
            <p className='mt-1 text-sm text-muted-foreground'>方格纸风格，手绘式日程框</p>
          </div>
        </div>
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'relative flex h-9 w-full flex-col items-center justify-center rounded-none border border-border/20 text-xs transition-all',
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-[11px] text-muted-foreground'>方格纸风格，手绘式日程框</p>
                    </div>
                  </div>
